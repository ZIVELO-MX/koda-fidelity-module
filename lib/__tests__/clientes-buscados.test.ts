...
describe("customer response contract", () => {
  it("normalizes legacy customers/maxStamps and C1 items/goal", () => {
    expect(normalizarClientes({ customers: [{ ...customer, goal: undefined }] })).toEqual(normalizarClientes({ items: [customer], page: 1, pageSize: 20, total: 1 }))
  })
