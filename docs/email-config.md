...
La vigencia del enlace de recuperación la controla Supabase Auth (`GOTRUE_MAILER_OTP_EXP`); el template no promete una duración fija. El enlace es de un solo uso y `/auth/confirm` rechaza tipos no soportados y destinos externos.
