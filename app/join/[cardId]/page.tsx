...
export default function JoinCardPage() {
  ...
  const handleAddToWallet = (wallet: "apple" | "google") => {
    // In a real app, this would generate the actual wallet pass
    setAdded(true)
  }
          ...
          {!added ? (
              ...
              {step === "name" ? (
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-card rounded-2xl p-6 border border-border">
                    ...
                    <p className="text-sm text-muted-foreground text-center mb-6">
                      Add this card to your phone&apos;s wallet for easy access
                    </p>

                    <div className="space-y-3">
                      <Button
                        onClick={() => handleAddToWallet("apple")}
                        className="w-full h-14 bg-foreground hover:bg-foreground/90 text-background"
                        size="lg"
                      >
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-xs text-muted-foreground">
                Show this QR code when you visit to earn stamps
              </p>
            </div>
          )}
        </div>
